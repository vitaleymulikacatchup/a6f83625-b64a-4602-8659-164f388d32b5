...
export const metadata: Metadata = {
  title: "F1 Demo - Experience Formula 1 Racing Technology",
  description: "Discover the cutting-edge technology, incredible speed, and precision engineering of Formula 1 racing cars. Explore advanced aerodynamics, hybrid power units, and real-time telemetry.",
  keywords: "Formula 1, F1 racing, racing technology, aerodynamics, hybrid engines, motorsport",
  metadataBase: new URL("https://f1demo.com"),
  alternates: {
    canonical: "https://f1demo.com"
  },
  openGraph: {
    title: "F1 Demo - Experience Formula 1 Racing Technology",
    description: "Discover the cutting-edge technology and incredible speed of Formula 1 racing cars",
    siteName: "F1 Demo",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1763460182308-ibcyduna.jpg",
  ...
  twitter: {
    ...
    title: "F1 Demo - Experience Formula 1 Racing Technology",
    description: "Discover the cutting-edge technology and incredible speed of Formula 1 racing cars",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1763460182308-ibcyduna.jpg"]
  },
  robots: {
    index: true,
    follow: true
